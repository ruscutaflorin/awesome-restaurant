/*
  ...
  - You are about to drop the column `permissions` on the `StaffUser` table. All the data in the column will be lost.
  - You are about to drop the column `schedule` on the `StaffUser` table. All the data in the column will be lost.
  - A unique constraint covering the columns `[userId]` on the table `StaffUser` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "StaffUser" DROP COLUMN "permissions",
